            ...
            <div class="box-body">
              ...
              //Se hace un array asociativo para poder sacar los valores
                  ...
                  <tr>
                    ...
                    <?php
                        $stmt2 =	Datos::getTutorID($datos["idUsuario"]);
                    ?>
                    <td align="center"><?= $stmt2["nombre"] ?></td>
                    <td style="width:40px"><a href="index.php?action=editarAlumno&id=<?= $datos["idAlumno"] ?>">
                    <button type="button" class="btn btn-warning">Editar</button>
                    </a></td>
                    <td><a href="index.php?action=eliminarAlumno&id=<?= $datos['idAlumno'] ?>">
