<?php
    $stmt =	Datos::getReporteSesiones($_SESSION["idUsuario"]);
    $stmt3 =	Datos::getReporteSesionesGrupales($_SESSION["idUsuario"]);
?>
        ...
        <div class="col-xs-12">
          ...
          <td align="center" style="width:50px"><b>Reporte</b></th>
              ...
              //Se hace un array asociativo para poder sacar los valores
                ...
                <td><a href="index.php?action=seguimiento&id=<?= $datos['idAlumno'] ?>&idSes=<?= $datos['idSesion'] ?>">
